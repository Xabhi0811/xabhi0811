...
### 🪶 Certifications  
<div style="display: grid; grid-template-columns: repeat(3, 200px); grid-template-rows: auto auto; gap: 25px; justify-content: center; align-items: center;">
  ...
  <a href="https://badgr.com/public/assertions/dgYgDuPnSxanKZEXPu2GtA" target="_blank">
    <img src="/images/postman.png" alt="Postman API Certification" height="200" width="200"/>
  </a>
